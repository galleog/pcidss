...
class EndPadderTest {
    ...
    inner class SingleBytePadderTest {
        ...
        fun `should pad with single-byte character`() {
            padder.pad(byteArrayOf(1, 2, 3), 5) shouldBe byteArrayOf(1, 2, 3, 0x30, 0x30)
        }
        ...
        fun `should unpad single-byte character correctly`() {
            val padded = byteArrayOf(1, 2, 3, 0x30, 0x30)
    ...
    inner class MultibytePadderTest {
        ...
        fun `should pad with multibyte character`() {
            ...
            padded[6] shouldBe padBytes[0]
            padded[7] shouldBe padBytes[1]
            padded[8] shouldBe padBytes[2]
        }
